...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Prepare samplesheet for pgsc_calc pipeline."
    )
    parser.add_argument(
        "--genotype-path",
        dest="genotype_path",
        default="/home/szabad/links/projects/def-sgravel/cartagene/flagship_array_imputed_w_cag_and_topmed_r3/PGEN/",
        type=str,
        ...
        data.append(
            {
                ...
                "path_prefix": osp.join(
                    args.genotype_path,
                    f"chr{chrom}.imputed_metaminimac_w_CaG_TOPMed_r3",
                ),
                "chrom": chrom,
    ...
    pd.DataFrame(data).to_csv(
        "pgsc_calc_requirements/samplesheets/cartagene.csv", index=False
    )
